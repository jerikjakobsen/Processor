...
void Vtop::traceInitThis__1(Vtop__Syms* __restrict vlSymsp, VerilatedVcd* vcdp, uint32_t code) {
	...
	vcdp->declBus  (c+7458,"top ID_WIDTH",-1,31,0);
	vcdp->declBus  (c+7459,"top ADDR_WIDTH",-1,31,0);
	vcdp->declBus  (c+7459,"top DATA_WIDTH",-1,31,0);
	vcdp->declBus  (c+7460,"top STRB_WIDTH",-1,31,0);
	...
	vcdp->declBit  (c+7461,"top L1_I_S_R_ADDR_VALID",-1);
	...
	vcdp->declBit  (c+7456,"top tmp3_signal",-1);
	...
	vcdp->declBit  (c+7461,"top rf write_ready",-1);
	vcdp->declBit  (c+3800,"top rf ecall",-1);
	vcdp->declBit  (c+3801,"top rf ecall_done",-1);
	vcdp->declBus  (c+7462,"top rf ECALL_IDLE",-1,1,0);
	vcdp->declBus  (c+7463,"top rf ECALL_IN_PROGRESS",-1,1,0);
	vcdp->declBus  (c+7464,"top rf ECALL_DONE",-1,1,0);
	...
	vcdp->declBus  (c+7459,"top llc LINE_COUNT",-1,31,0);
	vcdp->declBus  (c+7459,"top llc BYTES_PER_LINE",-1,31,0);
	vcdp->declBus  (c+7465,"top llc INDEX_SIZE",-1,31,0);
	vcdp->declBus  (c+7465,"top llc OFFSET_SIZE",-1,31,0);
	vcdp->declBus  (c+7466,"top llc TAG_SIZE",-1,31,0);
	vcdp->declBus  (c+7467,"top llc DATA_SIZE",-1,31,0);
	...
	vcdp->declBus  (c+7468,"top llc IDLE",-1,31,0);
	vcdp->declBus  (c+7469,"top llc W_R_REQUEST",-1,31,0);
	vcdp->declBus  (c+7470,"top llc R_REQUEST",-1,31,0);
	vcdp->declBus  (c+7471,"top llc R_DONE",-1,31,0);
	vcdp->declBus  (c+7472,"top llc W_REQUEST",-1,31,0);
	vcdp->declBus  (c+7473,"top llc W_DONE",-1,31,0);
	vcdp->declBus  (c+7468,"top llc AXI_W_IDLE",-1,31,0);
	vcdp->declBus  (c+7469,"top llc AXI_W_REQUEST",-1,31,0);
	vcdp->declBus  (c+7470,"top llc AXI_W_MEM",-1,31,0);
	vcdp->declBus  (c+7471,"top llc AXI_W_DONE",-1,31,0);
	vcdp->declBus  (c+7468,"top llc AXI_R_IDLE",-1,31,0);
	vcdp->declBus  (c+7469,"top llc AXI_R_REQUEST",-1,31,0);
	vcdp->declBus  (c+7470,"top llc AXI_R_READ",-1,31,0);
	vcdp->declBus  (c+7471,"top llc AXI_R_DONE",-1,31,0);
	...
	vcdp->declQuad (c+7474,"top llc latched_w_requested_tag",-1,51,0);
	vcdp->declQuad (c+5044,"top llc latched_w_selected_tag",-1,51,0);
	vcdp->declBus  (c+2534,"top llc w_requested_index",-1,5,0);
	vcdp->declBus  (c+7476,"top llc latched_w_requested_index",-1,5,0);
	...
	vcdp->declBus  (c+7459,"top l1_i LINE_COUNT",-1,31,0);
	vcdp->declBus  (c+7459,"top l1_i BYTES_PER_LINE",-1,31,0);
	vcdp->declBus  (c+7465,"top l1_i INDEX_SIZE",-1,31,0);
	vcdp->declBus  (c+7465,"top l1_i OFFSET_SIZE",-1,31,0);
	vcdp->declBus  (c+7466,"top l1_i TAG_SIZE",-1,31,0);
	vcdp->declBus  (c+7467,"top l1_i DATA_SIZE",-1,31,0);
	vcdp->declBit  (c+7403,"top l1_i clk",-1);
	vcdp->declBit  (c+7404,"top l1_i reset",-1);
	vcdp->declQuad (c+3768,"top l1_i S_R_ADDR",-1,63,0);
	vcdp->declBit  (c+7461,"top l1_i S_R_ADDR_VALID",-1);
	...
	vcdp->declBus  (c+7468,"top l1_i IDLE",-1,31,0);
	vcdp->declBus  (c+7470,"top l1_i R_REQUEST",-1,31,0);
	vcdp->declBus  (c+7468,"top l1_i L2_R_IDLE",-1,31,0);
	vcdp->declBus  (c+7469,"top l1_i L2_R_REQUEST",-1,31,0);
	vcdp->declBus  (c+7470,"top l1_i L2_R_DONE",-1,31,0);
	...
	vcdp->declBus  (c+7477,"top l1_i next_r_buffer_index",-1,2,0);
	...
	vcdp->declBus  (c+7459,"top l1_d LINE_COUNT",-1,31,0);
	vcdp->declBus  (c+7459,"top l1_d BYTES_PER_LINE",-1,31,0);
	vcdp->declBus  (c+7465,"top l1_d INDEX_SIZE",-1,31,0);
	vcdp->declBus  (c+7465,"top l1_d OFFSET_SIZE",-1,31,0);
	vcdp->declBus  (c+7466,"top l1_d TAG_SIZE",-1,31,0);
	vcdp->declBus  (c+7467,"top l1_d DATA_SIZE",-1,31,0);
	...
	vcdp->declBus  (c+7457,"top l1_d m_axi_acvalid",-1,3,0);
	vcdp->declBus  (c+7478,"top l1_d BYTE",-1,2,0);
	vcdp->declBus  (c+7479,"top l1_d HALF_WORD",-1,2,0);
	vcdp->declBus  (c+7480,"top l1_d WORD",-1,2,0);
	vcdp->declBus  (c+7481,"top l1_d DOUBLE_WORD",-1,2,0);
	vcdp->declBus  (c+7468,"top l1_d IDLE",-1,31,0);
	vcdp->declBus  (c+7469,"top l1_d W_R_REQUEST",-1,31,0);
	vcdp->declBus  (c+7470,"top l1_d R_REQUEST",-1,31,0);
	vcdp->declBus  (c+7471,"top l1_d R_DONE",-1,31,0);
	vcdp->declBus  (c+7472,"top l1_d W_REQUEST",-1,31,0);
	vcdp->declBus  (c+7473,"top l1_d W_DONE",-1,31,0);
	vcdp->declBus  (c+7465,"top l1_d R_W_PENDING_CACHE_WRITE",-1,31,0);
	vcdp->declBus  (c+7482,"top l1_d R_PENDING_CACHE_WRITE",-1,31,0);
	vcdp->declBus  (c+7468,"top l1_d L2_W_IDLE",-1,31,0);
	vcdp->declBus  (c+7469,"top l1_d L2_W_REQUEST",-1,31,0);
	vcdp->declBus  (c+7470,"top l1_d L2_W_MEM",-1,31,0);
	vcdp->declBus  (c+7471,"top l1_d L2_W_DONE",-1,31,0);
	vcdp->declBus  (c+7468,"top l1_d L2_R_IDLE",-1,31,0);
	vcdp->declBus  (c+7469,"top l1_d L2_R_REQUEST",-1,31,0);
	vcdp->declBus  (c+7470,"top l1_d L2_R_DONE",-1,31,0);
	...
	vcdp->declBus  (c+7483,"top l1_d next_r_buffer_index",-1,2,0);
	vcdp->declBus  (c+7367,"top l1_d w_buffer_index",-1,2,0);
	vcdp->declBus  (c+7484,"top l1_d next_w_buffer_index",-1,2,0);
	...
	vcdp->declBit  (c+7485,"top l1_d next_r_captured",-1);
	vcdp->declBit  (c+7375,"top l1_d w_complete",-1);
	vcdp->declBit  (c+7486,"top l1_d next_w_complete",-1);
	vcdp->declBit  (c+7376,"top l1_d pending_cache_write",-1);
	vcdp->declBit  (c+7487,"top l1_d next_pending_cache_write",-1);
	...
	vcdp->declQuad (c+7488,"top l1_d latched_w_requested_tag",-1,51,0);
	...
	vcdp->declBus  (c+7490,"top l1_d latched_w_requested_index",-1,5,0);
	vcdp->declBus  (c+1328,"top l1_d ac_addr_requested_index",-1,5,0);
	vcdp->declBus  (c+3761,"top l1_d r_requested_offset",-1,5,0);
	vcdp->declBus  (c+7459,"top if_stage ADDR_WIDTH",-1,31,0);
	vcdp->declBus  (c+7459,"top if_stage DATA_WIDTH",-1,31,0);
	vcdp->declBus  (c+7467,"top if_stage BUFFER_SIZE",-1,31,0);
	...
	vcdp->declBit  (c+7461,"top if_stage S_R_ADDR_VALID",-1);
	vcdp->declBus  (c+68,"top if_stage S_R_DATA",-1,31,0);
	vcdp->declBit  (c+30,"top if_stage S_R_DATA_VALID",-1);
	vcdp->declBus  (c+7462,"top if_stage IDLE",-1,1,0);
	vcdp->declBus  (c+7464,"top if_stage READ",-1,1,0);
	vcdp->declBus  (c+7398,"top if_stage state",-1,1,0);
	vcdp->declBus  (c+7491,"top if_stage next_state",-1,1,0);
	vcdp->declBus  (c+7459,"top id_stage ADDR_WIDTH",-1,31,0);
	vcdp->declBus  (c+7459,"top id_stage DATA_WIDTH",-1,31,0);
	...
	vcdp->declBus  (c+7492,"top id_stage IMM",-1,0,0);
	vcdp->declBus  (c+7493,"top id_stage REG2",-1,0,0);
	vcdp->declBus  (c+7494,"top id_stage NOP",-1,3,0);
	vcdp->declBus  (c+7495,"top id_stage ADD",-1,3,0);
	vcdp->declBus  (c+7496,"top id_stage SUB",-1,3,0);
	vcdp->declBus  (c+7497,"top id_stage OR",-1,3,0);
	vcdp->declBus  (c+7498,"top id_stage AND",-1,3,0);
	vcdp->declBus  (c+7499,"top id_stage XOR",-1,3,0);
	vcdp->declBus  (c+7500,"top id_stage MUL",-1,3,0);
	vcdp->declBus  (c+7501,"top id_stage MULH",-1,3,0);
	vcdp->declBus  (c+7502,"top id_stage DIV",-1,3,0);
	vcdp->declBus  (c+7503,"top id_stage REM",-1,3,0);
	vcdp->declBus  (c+7504,"top id_stage SHIFT_LEFT",-1,3,0);
	vcdp->declBus  (c+7505,"top id_stage SHIFT_RIGHT",-1,3,0);
	vcdp->declBus  (c+7506,"top id_stage SET_LESS_THAN",-1,3,0);
	vcdp->declBus  (c+7507,"top id_stage JUMP",-1,3,0);
	vcdp->declBus  (c+7508,"top id_stage PC_ADD",-1,3,0);
	vcdp->declBus  (c+7509,"top id_stage LOAD_REGISTER",-1,3,0);
	vcdp->declBus  (c+7478,"top id_stage BEQ",-1,2,0);
	vcdp->declBus  (c+7479,"top id_stage BNE",-1,2,0);
	vcdp->declBus  (c+7480,"top id_stage BLT",-1,2,0);
	vcdp->declBus  (c+7481,"top id_stage BGE",-1,2,0);
	vcdp->declBus  (c+7510,"top id_stage JAL",-1,2,0);
	vcdp->declBus  (c+7511,"top id_stage JALR",-1,2,0);
	vcdp->declBus  (c+7478,"top id_stage BYTE",-1,2,0);
	vcdp->declBus  (c+7479,"top id_stage HALF_WORD",-1,2,0);
	vcdp->declBus  (c+7480,"top id_stage WORD",-1,2,0);
	vcdp->declBus  (c+7481,"top id_stage DOUBLE_WORD",-1,2,0);
	vcdp->declBus  (c+7512,"top id_stage UNSIGNED_WORD",-1,2,0);
	vcdp->declBus  (c+7513,"top id_stage UNSIGNED_HALF_WORD",-1,2,0);
	vcdp->declBus  (c+7510,"top id_stage UNSIGNED_BYTE",-1,2,0);
	...
	vcdp->declBus  (c+7459,"top ex_stage ADDR_WIDTH",-1,31,0);
	vcdp->declBus  (c+7459,"top ex_stage DATA_WIDTH",-1,31,0);
	...
	vcdp->declBus  (c+7494,"top ex_stage NOP",-1,3,0);
	vcdp->declBus  (c+7495,"top ex_stage ADD",-1,3,0);
	vcdp->declBus  (c+7496,"top ex_stage SUB",-1,3,0);
	vcdp->declBus  (c+7497,"top ex_stage OR",-1,3,0);
	vcdp->declBus  (c+7498,"top ex_stage AND",-1,3,0);
	vcdp->declBus  (c+7499,"top ex_stage XOR",-1,3,0);
	vcdp->declBus  (c+7500,"top ex_stage MUL",-1,3,0);
	vcdp->declBus  (c+7501,"top ex_stage MULH",-1,3,0);
	vcdp->declBus  (c+7502,"top ex_stage DIV",-1,3,0);
	vcdp->declBus  (c+7503,"top ex_stage REM",-1,3,0);
	vcdp->declBus  (c+7504,"top ex_stage SHIFT_LEFT",-1,3,0);
	vcdp->declBus  (c+7505,"top ex_stage SHIFT_RIGHT",-1,3,0);
	vcdp->declBus  (c+7506,"top ex_stage SET_LESS_THAN",-1,3,0);
	vcdp->declBus  (c+7507,"top ex_stage JUMP",-1,3,0);
	vcdp->declBus  (c+7508,"top ex_stage PC_ADD",-1,3,0);
	vcdp->declBus  (c+7509,"top ex_stage LOAD_REGISTER",-1,3,0);
	vcdp->declBus  (c+7478,"top ex_stage BEQ",-1,2,0);
	vcdp->declBus  (c+7479,"top ex_stage BNE",-1,2,0);
	vcdp->declBus  (c+7480,"top ex_stage BLT",-1,2,0);
	vcdp->declBus  (c+7481,"top ex_stage BGE",-1,2,0);
	vcdp->declBus  (c+7510,"top ex_stage JAL",-1,2,0);
	vcdp->declBus  (c+7511,"top ex_stage JALR",-1,2,0);
	...
	vcdp->declBus  (c+7459,"top mem_stage ADDR_WIDTH",-1,31,0);
	vcdp->declBus  (c+7459,"top mem_stage DATA_WIDTH",-1,31,0);
	...
	vcdp->declBus  (c+7478,"top mem_stage IDLE",-1,2,0);
	vcdp->declBus  (c+7479,"top mem_stage READ_REQUEST",-1,2,0);
	vcdp->declBus  (c+7481,"top mem_stage READ",-1,2,0);
	vcdp->declBus  (c+7512,"top mem_stage WRITE_REQUEST",-1,2,0);
	vcdp->declBus  (c+7478,"top mem_stage BYTE",-1,2,0);
	vcdp->declBus  (c+7479,"top mem_stage HALF_WORD",-1,2,0);
	vcdp->declBus  (c+7480,"top mem_stage WORD",-1,2,0);
	vcdp->declBus  (c+7481,"top mem_stage DOUBLE_WORD",-1,2,0);
	vcdp->declBus  (c+7512,"top mem_stage UNSIGNED_WORD",-1,2,0);
	vcdp->declBus  (c+7513,"top mem_stage UNSIGNED_HALF_WORD",-1,2,0);
	vcdp->declBus  (c+7510,"top mem_stage UNSIGNED_BYTE",-1,2,0);
...
void Vtop::traceFullThis__1(Vtop__Syms* __restrict vlSymsp, VerilatedVcd* vcdp, uint32_t code) {
	...
	vcdp->fullBit  (c+103,((VL_ULL(0x3fbffe68) 
				== vlTOPp->top__DOT__L1_D_S_W_ADDR)));
	...
	vcdp->fullBit  (c+3804,((VL_ULL(0x296ac) == vlTOPp->top__DOT__pc)));
	...
	vcdp->fullBit  (c+7401,((VL_ULL(0x1aa6c) == vlTOPp->top__DOT__ex_instr_pc)));
	...
	vcdp->fullBit  (c+7456,((VL_ULL(0x3fbffe68) 
				 == vlTOPp->m_axi_acaddr)));
	vcdp->fullBus  (c+7457,(vlTOPp->m_axi_acvalid),4);
	vcdp->fullBus  (c+7458,(0xdU),32);
	vcdp->fullBus  (c+7459,(0x40U),32);
	vcdp->fullBus  (c+7460,(8U),32);
	vcdp->fullBit  (c+7461,(1U));
	vcdp->fullBus  (c+7462,(0U),2);
	vcdp->fullBus  (c+7463,(1U),2);
	vcdp->fullBus  (c+7464,(2U),2);
	vcdp->fullBus  (c+7465,(6U),32);
	vcdp->fullBus  (c+7466,(0x34U),32);
	vcdp->fullBus  (c+7467,(0x200U),32);
	vcdp->fullBus  (c+7468,(0U),32);
	vcdp->fullBus  (c+7469,(1U),32);
	vcdp->fullBus  (c+7470,(2U),32);
	vcdp->fullBus  (c+7471,(3U),32);
	vcdp->fullBus  (c+7472,(4U),32);
	vcdp->fullBus  (c+7473,(5U),32);
	vcdp->fullQuad (c+7474,(vlTOPp->top__DOT__llc__DOT__latched_w_requested_tag),52);
	vcdp->fullBus  (c+7476,(vlTOPp->top__DOT__llc__DOT__latched_w_requested_index),6);
	vcdp->fullBus  (c+7477,(vlTOPp->top__DOT__l1_i__DOT__next_r_buffer_index),3);
	vcdp->fullBus  (c+7478,(0U),3);
	vcdp->fullBus  (c+7479,(1U),3);
	vcdp->fullBus  (c+7480,(2U),3);
	vcdp->fullBus  (c+7481,(3U),3);
	vcdp->fullBus  (c+7482,(7U),32);
	vcdp->fullBus  (c+7483,(vlTOPp->top__DOT__l1_d__DOT__next_r_buffer_index),3);
	vcdp->fullBus  (c+7484,(vlTOPp->top__DOT__l1_d__DOT__next_w_buffer_index),3);
	vcdp->fullBit  (c+7485,(vlTOPp->top__DOT__l1_d__DOT__next_r_captured));
	vcdp->fullBit  (c+7486,(vlTOPp->top__DOT__l1_d__DOT__next_w_complete));
	vcdp->fullBit  (c+7487,(vlTOPp->top__DOT__l1_d__DOT__next_pending_cache_write));
	vcdp->fullQuad (c+7488,(vlTOPp->top__DOT__l1_d__DOT__latched_w_requested_tag),52);
	vcdp->fullBus  (c+7490,(vlTOPp->top__DOT__l1_d__DOT__latched_w_requested_index),6);
	vcdp->fullBus  (c+7491,(vlTOPp->top__DOT__if_stage__DOT__next_state),2);
	vcdp->fullBus  (c+7492,(1U),1);
	vcdp->fullBus  (c+7493,(0U),1);
	vcdp->fullBus  (c+7494,(0U),4);
	vcdp->fullBus  (c+7495,(1U),4);
	vcdp->fullBus  (c+7496,(2U),4);
	vcdp->fullBus  (c+7497,(3U),4);
	vcdp->fullBus  (c+7498,(4U),4);
	vcdp->fullBus  (c+7499,(5U),4);
	vcdp->fullBus  (c+7500,(6U),4);
	vcdp->fullBus  (c+7501,(7U),4);
	vcdp->fullBus  (c+7502,(8U),4);
	vcdp->fullBus  (c+7503,(9U),4);
	vcdp->fullBus  (c+7504,(0xaU),4);
	vcdp->fullBus  (c+7505,(0xbU),4);
	vcdp->fullBus  (c+7506,(0xcU),4);
	vcdp->fullBus  (c+7507,(0xdU),4);
	vcdp->fullBus  (c+7508,(0xeU),4);
	vcdp->fullBus  (c+7509,(0xfU),4);
	vcdp->fullBus  (c+7510,(6U),3);
	vcdp->fullBus  (c+7511,(7U),3);
	vcdp->fullBus  (c+7512,(4U),3);
	vcdp->fullBus  (c+7513,(5U),3);
    }
}
