...
VL_MODULE(Vtop) {
  public:
    ...
    VL_SIG8(top__DOT__L1_D_S_W_READY,0,0);
    VL_SIG8(top__DOT__L1_D_S_W_COMPLETE,0,0);
    VL_SIG8(top__DOT__L2_S_R_ADDR_VALID,0,0);
    VL_SIG8(top__DOT__L2_S_R_ADDR_VALID_1,0,0);
    VL_SIG8(top__DOT__L2_S_R_ADDR_VALID_2,0,0);
    VL_SIG8(top__DOT__L2_S_R_DATA_VALID,0,0);
    VL_SIG8(top__DOT__L2_S_R_DATA_VALID_1,0,0);
    VL_SIG8(top__DOT__L2_S_R_DATA_VALID_2,0,0);
    VL_SIG8(top__DOT__L2_S_W_VALID,0,0);
    VL_SIG8(top__DOT__L2_S_W_READY,0,0);
    ...
    VL_SIG8(top__DOT__llc__DOT__r_selected_block_is_valid,0,0);
    VL_SIG8(top__DOT__llc__DOT__w_selected_block_is_valid,0,0);
    VL_SIG8(top__DOT__llc__DOT__r_selected_block_is_dirty,0,0);
    VL_SIG8(top__DOT__llc__DOT__w_selected_block_is_dirty,0,0);
    VL_SIG8(top__DOT__llc__DOT__r_requested_index,5,0);
    ...
    VL_SIG8(top__DOT__l1_d__DOT__next_L2_S_W_VALID,0,0);
    ...
    VL_SIG8(top__DOT__mem_stage__DOT__next_S_R_ADDR_VALID,0,0);
    VL_SIG8(top__DOT__mem_stage__DOT__next_S_W_VALID,0,0);
    ...
    VL_SIGW(top__DOT__llc__DOT__r_selected_data,511,0,16);
    ...
    VL_SIGW(top__DOT__l1_d__DOT__next_L2_S_W_DATA,511,0,16);
    ...
    VL_SIG64(top__DOT__L2_S_R_ADDR_1,63,0);
    VL_SIG64(top__DOT__L2_S_R_ADDR_2,63,0);
    ...
    VL_SIG64(top__DOT__llc__DOT__r_requested_tag,51,0);
    VL_SIG64(top__DOT__llc__DOT__r_selected_tag,51,0);
    ...
    VL_SIG64(top__DOT__l1_d__DOT__next_L2_S_W_ADDR,63,0);
    ...
    VL_SIG64(top__DOT__mem_stage__DOT__next_S_R_ADDR,63,0);
    VL_SIG64(top__DOT__mem_stage__DOT__next_S_W_ADDR,63,0);
    VL_SIG64(top__DOT__mem_stage__DOT__next_S_W_DATA,63,0);
    ...
    VL_SIG64(top__DOT__l1_d__DOT____Vlvbound2,51,0);
    VL_SIG64(top__DOT__l1_d__DOT____Vlvbound7,51,0);
    
    // INTERNAL VARIABLES
    // Internals; generally not touched by application code
    //char	__VpadToAlign29940[4];
